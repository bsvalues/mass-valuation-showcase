...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navSuites = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: LineChart, label: "Ratio Study Analyzer", href: "/ratio-study-analyzer" },
        { icon: Network, label: "Value Driver Analysis", href: "/value-drivers" },
        { icon: FlameKindling, label: "Cluster Heatmap", href: "/cluster-map" },
        { icon: Thermometer, label: "Property Heatmap", href: "/property-heatmap" },
        { icon: LayoutDashboard, label: "Mass Appraisal Dashboard", href: "/mass-appraisal-dashboard" },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: BarChart3, label: "Appeals Analytics", href: "/appeals/analytics" },
      ]
    },
    {
      title: "PLATFORM",
  ...
  const getBreadcrumbItems = (path: string) => {
    const routeMap: Record<string, { suite: string; page: string }> = {
      ...
      '/ratio-study-analyzer': { suite: 'Analysis Suite', page: 'Ratio Study Analyzer' },
      '/value-drivers': { suite: 'Analysis Suite', page: 'Value Driver Analysis' },
      '/cluster-map': { suite: 'Analysis Suite', page: 'Cluster Heatmap' },
      '/property-heatmap': { suite: 'Analysis Suite', page: 'Property Heatmap' },
      '/mass-appraisal-dashboard': { suite: 'Analysis Suite', page: 'Mass Appraisal Dashboard' },
      '/appeals': { suite: 'Governance Suite', page: 'Appeals Management' },
      '/appeals/analytics': { suite: 'Governance Suite', page: 'Appeals Analytics' },
